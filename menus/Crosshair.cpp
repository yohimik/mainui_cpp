...
{
public:
	CMenuCrosshair() : CMenuFramework ( "CMenuCrosshair" ) { }
private:
	void _Init() override;
...
public:
	...
	class CMenuCrosshairVisual : public CMenuBaseItem
	{
	public:
		void Draw() override;
...
int CMenuCrosshair::CMenuCrosshairVisual::ScaleForRes( float value, int height )
{
	/* "default" resolution is 640x480 */
	return rint( value * ( (float)height / 480.0f ) );
}

void CMenuCrosshair::CMenuCrosshairVisual::DrawCrosshairSection( int _x0, int _y0, int _x1, int _y1, CMenuCrosshair *parent )
{	
	float x0 = (float)_x0;
	float y0 = (float)_y0;
...
void CMenuCrosshair::CMenuCrosshairVisual::DrawCrosshairPadding( int _pad, int _x0, int _y0, int _x1, int _y1, CMenuCrosshair *parent )
{	
...
void CMenuCrosshair::CMenuCrosshairVisual::Draw()
{
